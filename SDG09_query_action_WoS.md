...
This query consists of one phrase. This phrase is about increasing the access to information and comminication technology. Basic structure is action + internet connection/mobile network + least developed countries. 
