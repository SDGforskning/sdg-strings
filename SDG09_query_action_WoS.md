...
TS=
(
	("advance" OR "advancing" OR "develop" OR "developing" OR "enhanc*" OR "foster*" OR "improv*" OR "invent$" OR "inventing" OR "moderni*" OR "upgrad*" OR "strengthen*" OR "better" 
	OR "build" OR "encourag*" OR "promot*" OR "plan"
	)  
		NEAR/5 
		(
