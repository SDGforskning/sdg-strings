...
NEAR/5  ("transport*" OR bus$ OR underground* OR tube* OR taxi* OR rail* OR boat* OR ferry OR plane* OR vehicl* OR bike* OR scooter* OR van* OR road* OR street* OR travel* OR vessel*) 
