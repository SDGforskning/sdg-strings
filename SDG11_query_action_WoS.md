...
```Ceylon =
TS= (("transport system*" AND ("safe*" OR "secure*" OR "sustainab*" OR "access*" OR affordable OR reliable))
...
“public transport*” OR ”pedestrian*” OR "maritim*"  OR "socio*" OR journey OR airport* OR cycl*))
```
##### Phrase 2:
